...
NLD <- readRDS("./data/gadm36_NLD_1_sp.rds")
...
parkrun_zuiderpark <- c("eventname" = "Zuiderpark, Hoogeveen", 
                        "Longitude" = 6.4835483, 
                        "Latitude" = 52.7109916, 
                        "Status" = "Planned")
parkrun_enschede <- c("eventname" = "Enschede", 
                      "Longitude" = 6.836273,  
                      "Latitude" = 52.2206737,
                      "Status" = "Planned")
...
filename <- paste("./data/pakruns_NL_", format(Sys.time(), "%Y%m%d-%H%M"), ".png", sep = "")
...
ggsave("./data/noborder.png", height = 800, dpi = 100, units = "px", bg="white")
